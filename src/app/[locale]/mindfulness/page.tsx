...
export default function MindfulnessPage() {
  const t = useTranslations("Feature_Mindfulness");
  ...
  return (
    <FeatureLandingPage
      ...
      painPoints={[
        { icon: "library_books", title: t("pain1Title"), detail: t("pain1Detail") },
      ...
      comparison={{
        ...
        sources: [
          ...
          { label: "Breathwrk", url: "https://www.breathwrk.com/" },
        ],
        disclaimer: t("compDisclaimer"),
      }}
      testimonialsHeading={plain("testimonialsHeading")}
      testimonials={[
        { quote: t("test1Quote"), name: t("test1Name"), age: Number(t("test1Age")), image: "/images/testimonials/kristiyan.png" },
        { quote: t("test2Quote"), name: t("test2Name"), age: Number(t("test2Age")), image: "/images/testimonials/t-154.png" },
        { quote: t("test3Quote"), name: t("test3Name"), age: Number(t("test3Age")), image: "/images/testimonials/t-155.png" },
      ]}
