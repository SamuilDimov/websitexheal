...
export default function FlareUpTriggerPatternsPage() {
  const t = useTranslations("Feature_FlareUp");
  ...
  return (
    <FeatureLandingPage
      ...
      painPoints={[
        ...
        { icon: "repeat", title: t("pain2Title"), detail: t("pain2Detail") },
        { icon: "emergency", title: t("pain3Title"), detail: t("pain3Detail") },
      ]}
      ...
      comparison={{
        ...
        rows: [
          ...
          { feature: t("compRow2Feature"), values: ["yes", "yes", t("compRow2Val3"), "yes"] },
          { feature: t("compRow3Feature"), values: ["no", "no", "yes", "yes"] },
          ...
          { feature: t("compRow7Feature"), values: [t("compRow7Val1"), t("compRow7Val2"), t("compRow7Val3"), t("compRow7Val4")] },
          { feature: t("compRow8Feature"), values: ["no", t("compRow8Val2"), "yes", "yes"] },
          { feature: t("compRow9Feature"), values: ["no", "no", "no", "yes"] },
          { feature: t("compRow10Feature"), values: ["no", "no", "no", t("compRow10Val4")] },
        ],
      ...
      testimonials={[
        { quote: t("test1Quote"), name: t("test1Name"), age: Number(t("test1Age")), image: "/images/testimonials/t-100.png" },
        { quote: t("test2Quote"), name: t("test2Name"), age: Number(t("test2Age")), image: "/images/testimonials/t-101.png" },
        { quote: t("test3Quote"), name: t("test3Name"), age: Number(t("test3Age")), image: "/images/testimonials/t-104.png" },
      ]}
