...
export default function NutritionPage() {
  const t = useTranslations("Feature_Nutrition");
  ...
  return (
    <FeatureLandingPage
      ...
      painPoints={[
        { icon: "calculate", title: t("pain1Title"), detail: t("pain1Detail") },
        { icon: "no_meals", title: t("pain2Title"), detail: t("pain2Detail") },
        { icon: "splitscreen", title: t("pain3Title"), detail: t("pain3Detail") },
      ]}
      ...
      comparison={{
        ...
        sources: [
          ...
          { label: "Cronometer", url: "https://cronometer.com/features/" },
          { label: "Lifesum", url: "https://lifesum.com/" },
        ],
        disclaimer: t("compDisclaimer"),
      }}
      testimonialsHeading={accent("testimonialsHeading")}
      testimonials={[
        { quote: t("test1Quote"), name: t("test1Name"), age: Number(t("test1Age")), image: "/images/testimonials/t-044.png" },
        { quote: t("test2Quote"), name: t("test2Name"), age: Number(t("test2Age")), image: "/images/testimonials/t-045.png" },
        { quote: t("test3Quote"), name: t("test3Name"), age: Number(t("test3Age")), image: "/images/testimonials/t-046.png" },
      ]}
